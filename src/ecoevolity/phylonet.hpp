...
#ifndef ECOEVOLITY_PHYLONET_HPP
#define ECOEVOLITY_PHYLONET_HPP
...
class BasePopulationNetwork : public BaseTree<PopulationNetNode> {
    protected:
        BiallelicData data_;
        ...
        void set_root(std::shared_ptr<PopulationNetNode> root);
    ...
    public:
        ...
        BasePopulationNetwork(
                std::shared_ptr<PopulationNetNode> root
            ) : BaseTree<PopulationNetNode>(root) { }

        BasePopulationNetwork(
                std::istream & tree_stream,
                const std::string & ncl_file_format
            ) : BaseTree<PopulationNetNode>(tree_stream, ncl_file_format) { }
        ...
        BasePopulationNetwork(
            ...
            ) : BaseTree<PopulationNetNode>(tree_description, taxa_block,
