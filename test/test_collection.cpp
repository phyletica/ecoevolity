...
TEST_CASE("Testing draw_heights_from_prior for WDP with 3 pairs and alpha 1.0, discount 0",
        "[xComparisonPopulationTreeCollection]") {

    SECTION("Testing draw_heights_from_prior for WDP with 3 pairs and alpha 1.0, discount 0") {
        std::string cfg_path = "data/dummy.yml";
        ...
        for (std::string m: {"000", "001", "010", "011", "012"}) {
            REQUIRE((model_counts.at(m) / (double)nsamples) == Approx(std::exp(
                    get_wdp_log_prior_probability(m, concentration, discount))).epsilon(0.01));
        }
    }
}
...
TEST_CASE("Testing draw_heights_from_prior for WDP with 3 pairs and alpha 1.0, discount 0.6",
        "[xComparisonPopulationTreeCollection]") {

    SECTION("Testing draw_heights_from_prior for WDP with 3 pairs and alpha 1.0, discount 0.6") {
        std::string cfg_path = "data/dummy.yml";
...
TEST_CASE("Testing draw_from_prior for WDP with 3 pairs and conc 1.0, discount 0.4",
        "[xComparisonPopulationTreeCollection]") {

    SECTION("Testing draw_from_prior for WDP with 3 pairs and conc 1.0, discount 0.4") {
        std::string cfg_path = "data/dummy.yml";
...
TEST_CASE("Testing draw_from_prior for WDP with variable conc and discount",
        "[xComparisonPopulationTreeCollection]") {

    SECTION("Testing draw_from_prior for WDP with variable conc and discount") {
        std::string cfg_path = "data/dummy.yml";
...
TEST_CASE("Testing draw_from_prior logging for WDP with variable conc and discount",
        "[xComparisonPopulationTreeCollection]") {

    SECTION("Testing draw_from_prior logging for WDP with variable conc and discount") {
        std::string cfg_path = "data/dummy.yml";
        ...
        // based on 10 million sims
        REQUIRE((model_counts.at("000") / (double)expected_sample_size) == Approx(0.1466).epsilon(0.005));
        REQUIRE((model_counts.at("012") / (double)expected_sample_size) == Approx(0.4243).epsilon(0.005));
