...
TEST_CASE("Testing simcoevolity relaxed constant sites setting for dirichlet trees",
    ...
    SECTION("Testing constant sites relaxed for dirichlet trees") {
        ...
        std::string log_path = "data/tmp-config-" + tag + "t25-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing simcoevolity missing sites error", "[SimcoevolityCLI]") {
    ...
    SECTION("Testing missing sites error") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _SIMCOEVOLITY_CLI_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t26.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t27-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing simcoevolity missing sites error for dirichlet trees", "[SimcoevolityCLI]") {
    ...
    SECTION("Testing missing sites error for dirichlet trees") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _SIMCOEVOLITY_CLI_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t28.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t29-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing simcoevolity relaxed missing sites setting", "[SimcoevolityCLI]") {
    ...
    SECTION("Testing missing sites relaxed") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _SIMCOEVOLITY_CLI_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t30.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t31-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing simcoevolity relaxed missing sites setting for dirichlet trees",
    ...
    SECTION("Testing missing sites relaxed for dirichlet trees") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _SIMCOEVOLITY_CLI_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t32.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t33-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing simcoevolity constrained singleton error",
    ...
    SECTION("Testing error for singleton with constrained pop size") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _SIMCOEVOLITY_CLI_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t34.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t35-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing simcoevolity fixed singleton error",
    ...
    SECTION("Testing error for singleton with fixed pop size") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _SIMCOEVOLITY_CLI_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t36.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t37-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing simcoevolity fixed singleton error for dirichlet tree",
    ...
    SECTION("Testing error for dirichlet singleton with fixed pop size") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _SIMCOEVOLITY_CLI_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t38.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t39-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing simcoevolity population label conflict", "[SimcoevolityCLI]") {
    ...
    SECTION("Testing duplicate pop labels") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _SIMCOEVOLITY_CLI_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t40.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t41-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing simcoevolity parameters only setting", "[SimcoevolityCLI]") {
    ...
    SECTION("Testing parameters only.") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _SIMCOEVOLITY_CLI_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t42.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t43-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing simcoevolity triallelic sites error", "[xSimcoevolityCLI]") {
    ...
    SECTION("Testing triallelic sites error") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _SIMCOEVOLITY_CLI_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t44.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t45-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing simcoevolity relax triallelic sites option", "[xSimcoevolityCLI]") {
    ...
    SECTION("Testing relax triallelic sites option") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _SIMCOEVOLITY_CLI_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t46.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t47-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
