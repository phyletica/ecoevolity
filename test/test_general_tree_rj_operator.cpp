...
TEST_CASE("Testing SplitLumpNodesRevJumpSampler with 4 leaves and fixed root",
    ...
    SECTION("Testing 4 leaves with fixed root") {
        ...
        write_r_script(split_counts, 4, "../4-leaf-general-tree-test.r");
...
TEST_CASE("Testing SplitLumpNodesRevJumpSampler with 5 leaves and fixed root",
    ...
    SECTION("Testing 5 leaves with fixed root") {
        ...
        write_r_script(split_counts, 5, "../5-leaf-general-tree-test.r");
...
TEST_CASE("Testing SplitLumpNodesRevJumpSampler with 5 leaves, fixed root, and auto opt",
        "[SplitLumpNodesRevJumpSampler]") {

    SECTION("Testing 5 leaves with fixed root and auto opt") {
        RandomNumberGenerator rng = RandomNumberGenerator(5485472);
        ...
        write_r_script(split_counts, 5, "../5-leaf-general-tree-test-rj-auto-opt.r");
...
TEST_CASE("Testing suite of SplitLumpNodesRevJumpSampler with 5 leaves, fixed root",
        "[xSplitLumpNodesRevJumpSampler]") {

    SECTION("Testing 5 leaves with fixed root and op suite") {
        RandomNumberGenerator rng = RandomNumberGenerator(42654264);
        ...
        op = std::make_shared< SplitLumpNodesRevJumpSampler< BaseTree<Node> > >(1.0);
        op->turn_off_auto_optimize();
        op->set_coercable_parameter_value(10.0);
        op_schedule.add_operator(op);
        ...
        write_r_script(split_counts, 5, "../5-leaf-general-tree-test-rj-suite.r");
...
TEST_CASE("Testing SplitLumpNodesRevJumpSampler with 6 leaves and fixed root",
    ...
    SECTION("Testing 6 leaves with fixed root") {
        ...
        write_r_script(split_counts, 6, "../6-leaf-general-tree-test.r");
...
TEST_CASE("Testing SplitLumpNodesRevJumpSampler with 7 leaves and fixed root",
    ...
    SECTION("Testing 7 leaves with fixed root") {
        ...
        write_r_script(split_counts, 7, "../7-leaf-general-tree-test.r");
...
TEST_CASE("Testing SplitLumpNodesRevJumpSampler with BasePopulationTree, 5 leaves, fixed sizes, and fixed root",
    ...
    SECTION("Testing 5 leaves with BasePopulationTree, fixed sizes") {
        ...
        write_r_script(split_counts, 5, "../5-leaf-general-tree-test-fixed-pop-sizes.r");
...
TEST_CASE("Testing SplitLumpNodesRevJumpSampler with BasePopulationTree, 5 leaves, constrained sizes, and fixed root",
    ...
    SECTION("Testing 5 leaves with BasePopulationTree, constrained sizes") {
        ...
        write_r_script(split_counts, 5, "../5-leaf-general-tree-test-constrained-pop-sizes.r");
...
TEST_CASE("Testing SplitLumpNodesRevJumpSampler with BasePopulationTree, 5 leaves, full model, constrained sizes",
    ...
    SECTION("Testing 5 leaves with BasePopulationTree, full model, constrained, sizes") {
        ...
        write_r_script(split_counts, 5, "../5-leaf-general-tree-test-full-model-constrained-pop-sizes.r");
