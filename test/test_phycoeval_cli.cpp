...
TEST_CASE("Testing phycoeval cli with 5 leaves, comb starting tree, full model, unconstrained sizes",
        "[phycoeval]") {

    SECTION("Testing 5 leaves with comb starting tree, full model, unconstrained sizes") {
        ...
        unsigned int chain_length = 4000000;
...
TEST_CASE("Testing phycoeval cli with 5 leaves, random starting tree, full model, unconstrained sizes",
        "[phycoeval]") {

    SECTION("Testing 5 leaves with random starting tree, full model, unconstrained sizes") {
        RandomNumberGenerator rng = RandomNumberGenerator(4524521);
        ...
        unsigned int chain_length = 1000000;
