...
TEST_CASE("phylonet; Testing simulations against likelihood for network with 2,1;2,2 pattern and opposite inheritance",
        /* "[BasePopulationNetwork]") { */
        "[xx]") {
    ...
    SECTION("Testing sims v likelihood for 2 retic pops with 2,1;2,2") {
        ...
        internal1->add_child(child1);
        tinternal1->add_child(tchild1);
        tinternal1->add_child(tinternal0);
        internal1->add_parent(root);
        tinternal1->add_parent(troot);
        child0->remove_parent(root);
        child1->remove_parent(root);
        ...
        // Turning off gene flow
        internal0->set_inheritance_proportion(0, 0.0);
...
TEST_CASE("phylonet; Testing simulations against likelihood for network with 2,1;2,2 pattern and 50/50 inheritance",
        /* "[BasePopulationNetwork]") { */
        "[x]") {
    ...
    SECTION("Testing sims v likelihood for 2 retic pops with 2,1;2,2") {
        ...
        // Turning on gene flow
        internal0->set_inheritance_proportion(0, 0.5);
