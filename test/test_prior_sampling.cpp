...
TEST_CASE("Testing sampling from prior with TimeSizeRateMixer with 6 pairs", "[SamplingPrior]") {
    ...
    SECTION("Testing 6 pairs with optimizing") {
        ...
        std::string test_path = "data/tmp-config-collection-scaler-test1-" + tag + "t879.cfg";
        std::string log_path = "data/tmp-config-collection-scaler-test1-" + tag + "t880-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
...
TEST_CASE("Testing sampling from prior with TimeSizeRateMixer no opt", "[SamplingPrior]") {
    ...
    SECTION("Testing gamma(10.0, 0.1) and gamma(5.0, 0.5) prior and no optimizing") {
        ...
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-collection-scaler-test1-" + tag + "t881.cfg";
        std::string log_path = "data/tmp-config-collection-scaler-test1-" + tag + "t882-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling from prior with TimeSizeRateMixer with opt", "[SamplingPrior]") {
    SECTION("Testing gamma(10.0, 0.1) and gamma(5.0, 0.5) prior with optimizing") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-collection-scaler-test2-" + tag + "t883.cfg";
        std::string log_path = "data/tmp-config-collection-scaler-test2-" + tag + "t884-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling from prior with TimeSizeRateMixer for singleton with opt", "[SamplingPrior]") {
    SECTION("Testing gamma(10.0, 0.1) and gamma(5.0, 0.5) prior for singleton with optimizing") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-collection-scaler-test2-" + tag + "t885.cfg";
        std::string log_path = "data/tmp-config-collection-scaler-test2-" + tag + "t886-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling from prior with TimeSizeRateMixer with constrained pop sizes and opt", "[SamplingPrior]") {
    SECTION("Testing gamma(10.0, 0.1) and gamma(5.0, 0.5) prior with constrained pop sizes and optimizing") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-collection-scaler-test3-" + tag + "t887.cfg";
        std::string log_path = "data/tmp-config-collection-scaler-test3-" + tag + "t888-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling from prior with TimeSizeRateMixer with fixed pop sizes and 2 pairs", "[SamplingPrior]") {
    SECTION("Testing gamma(10.0, 0.1) and gamma(5.0, 0.5) prior with fixed pop sizes, optimizing, 2 pairs") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-collection-scaler-test3-" + tag + "t889.cfg";
        std::string log_path = "data/tmp-config-collection-scaler-test3-" + tag + "t890-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
...
TEST_CASE("Testing sampling from prior with TimeSizeRateMixer with more gamma priors opt", "[SamplingPrior]") {
    SECTION("Testing gamma(10.0, 10.0) and gamma(2.0, 0.5) prior with optimizing") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-collection-scaler-test4-" + tag + "t891.cfg";
        std::string log_path = "data/tmp-config-collection-scaler-test4-" + tag + "t892-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling from prior with EventTimeScaler", "[SamplingPrior]") {
    ...
    SECTION("Testing gamma(10.0, 0.1) prior and no optimizing") {
        ...
        std::string auto_optimize = "false";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t893.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t894-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling from prior with EventTimeScaler with optimizing",
    ...
    SECTION("Testing gamma(10.0, 0.1) prior and optimizing") {
        ...
        std::string auto_optimize = "false";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-comp-height-scaler-" + tag + "t895.cfg";
        std::string log_path = "data/tmp-config-comp-height-scaler-" + tag + "t896-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling from prior with RootPopulationSizeScaler", "[SamplingPrior]") {
    ...
    SECTION("Testing gamma(10.0, 0.1) prior and no optimizing") {
        ...
        std::string auto_optimize = "false";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t897.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t898-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling from prior with RootPopulationSizeScaler with optimizing", "[SamplingPrior]") {
    ...
    SECTION("Testing gamma(10.0, 0.1) prior and optimizing") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-root-pop-size-scaler-" + tag + "t899.cfg";
        std::string log_path = "data/tmp-config-root-pop-size-scaler-" + tag + "t900-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling from prior with LeafPopulationSizeScaler", "[SamplingPrior]") {
    ...
    SECTION("Testing gamma(10.0, 0.1) prior and no optimizing") {
        ...
        std::string auto_optimize = "false";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t901.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t902-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling from prior with LeafPopulationSizeScaler with optimizing", "[SamplingPrior]") {
    ...
    SECTION("Testing gamma(10.0, 0.1) prior and optimizing") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t903.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t904-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling from prior with RootPopulationSizeScaler and LeafPopulationSizeScaler on constrained sizes",
    ...
    SECTION("Testing gamma(10.0, 0.1) prior and no optimizing") {
        ...
        std::string auto_optimize = "false";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t905.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t906-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling from prior with RootPopulationSizeScaler and LeafPopulationSizeScaler on constrained sizes with optimizing",
    ...
    SECTION("Testing gamma(10.0, 0.1) prior and optimizing") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t907.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t908-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling from beta(1.5, 2.5) prior with FreqMover",
    ...
    SECTION("Testing beta(1.5, 2.5) prior and no optimizing") {
        ...
        std::string auto_optimize = "false";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t909.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t910-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling from beta(1.5, 2.5) prior with FreqMover and optimizing",
    ...
    SECTION("Testing beta(1.5, 2.5) prior and optimizing") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t911.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t912-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling from beta(2.5, 1.5) prior with FreqMover and optimizing",
    ...
    SECTION("Testing beta(2.5, 1.5) prior and optimizing") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t913.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t914-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling from prior with MutationRateScaler",
    ...
    SECTION("Testing gamma(10.0, 0.1) prior and no optimizing") {
        ...
        std::string auto_optimize = "false";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t915.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t916-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling from prior with MutationRateScaler with optimizing",
    ...
    SECTION("Testing gamma(10.0, 0.1) prior and optimizing") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t917.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t918-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing fully parameterized model for one pair",
    ...
    SECTION("Testing with no optimizing") {
        ...
        std::string auto_optimize = "false";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t919.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t920-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing fully parameterized model for one pair with optimization",
    ...
    SECTION("Testing with optimizing") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t921.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t922-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing fully parameterized model for one pair with optimization and TimeSizeRateMixer",
    ...
    SECTION("Testing with optimizing") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t923.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t924-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing DPP with 2 pairs and alpha 1.0", "[SamplingPrior]") {
    ...
    SECTION("Testing alpha fixed to 1.0") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t925.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t926-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing DPP with 2 pairs and alpha 2.0", "[SamplingPrior]") {
    ...
    SECTION("Testing alpha fixed to 2.0") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t927.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t928-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing DPP with 2 pairs and alpha 0.5", "[SamplingPrior]") {
    ...
    SECTION("Testing alpha fixed to 0.5") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t929.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t930-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing DPP with 3 pairs and alpha 1.0", "[SamplingPrior]") {
    ...
    SECTION("Testing alpha fixed to 1.0") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t931.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t932-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing DPP with 3 pairs and alpha 4.0", "[SamplingPrior]") {
    ...
    SECTION("Testing alpha fixed to 4.0") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t933.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t934-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing DPP with 6 pairs and alpha 1.7", "[SamplingPrior]") {
    ...
    SECTION("Testing alpha fixed to 1.7") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t935.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t936-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing DPP with 3 pairs and fully parameterized", "[SamplingPrior]") {
    ...
    SECTION("Testing alpha integrated") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t937.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t938-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing DPP with 3 pairs and fully parameterized and TimeSizeRateMixer",
    ...
    SECTION("Testing alpha integrated") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t939.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t940-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling of small concentration", "[SamplingPrior]") {
    ...
    SECTION("Testing concentration sampling") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t941.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t942-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling of large concentration", "[SamplingPrior]") {
    ...
    SECTION("Testing concentration sampling") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t943.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t944-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing sampling of diffuse concentration", "[SamplingPrior]") {
    ...
    SECTION("Testing concentration sampling") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t945.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t946-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing DPP with 3 pairs, fully parameterized, and 3 threads",
    ...
    SECTION("Testing multithreading") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t947.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t948-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing DPP with 3 pairs, fully parameterized, and 2 threads",
    ...
    SECTION("Testing nthreads 2") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t949.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t950-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing ReversibleJumpSampler with 2 pairs", "[SamplingPrior]") {
    ...
    SECTION("Testing rjMCMC with 2 pairs") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t951.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t952-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing ReversibleJumpSampler with 3 pairs", "[SamplingPrior]") {
    ...
    SECTION("Testing rjMCMC with 3 pairs") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t953.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t954-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing ReversibleJumpSampler with 6 pairs", "[SamplingPrior]") {
    ...
    SECTION("Testing rjMCMC with 6 pairs") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t955.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t956-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing ReversibleJumpSampler with 6 pairs and diffuse gamma", "[SamplingPrior]") {
    ...
    SECTION("Testing rjMCMC with 6 pairs and diffuse gamma") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t957.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t958-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing ReversibleJumpSampler with 3 pairs and fully parameterized", "[SamplingPrior]") {
    ...
    SECTION("Testing rjMCMC with 3 pairs") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t959.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t960-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing ReversibleJumpSampler with 3 pairs and fully parameterized and TimeSizeRateMixer",
    ...
    SECTION("Testing rjMCMC with 3 pairs") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t961.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t962-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing ReversibleJumpSampler with 3 pairs, fully parameterized, and 2 threads",
    ...
    SECTION("Testing rjMCMC with 3 pairs and 2 threads") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t963.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t964-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing DPP with 2 singletons and 1 pair, fully parameterized",
    ...
    SECTION("Testing alpha integrated") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t965.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t966-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing DPP with 2 singletons and 1 pair, fully parameterized, and TimeSizeRateMixer",
    ...
    SECTION("Testing alpha integrated") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t967.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t968-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing ReversibleJumpSampler with 2 singletons, 1 pair, and fully parameterized",
    ...
    SECTION("Testing rjMCMC with 2 singletons and a pair") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t969.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t970-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing ReversibleJumpSampler with 2 singletons, 1 pair, TimeSizeRateMixer, and fully parameterized",
    ...
    SECTION("Testing rjMCMC with 2 singletons and a pair") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t971.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t972-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing fixed 012 and fully parameterized", "[SamplingPrior]") {
    ...
    SECTION("Testing fixed 012 pairs") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t973.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t974-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing fixed 012 and fully parameterized and TimeSizeRateMixer",
    ...
    SECTION("Testing fixed 012 pairs") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t975.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t976-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing fixed 000 and fully parameterized", "[SamplingPrior]") {
    ...
    SECTION("Testing fixed 000 pairs") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t977.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t978-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing fixed 000 and fully parameterized and TimeSizeRateMixer",
    ...
    SECTION("Testing fixed 000 pairs") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t979.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t980-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing DPP with 3 dirichlet pairs and fully parameterized", "[SamplingPrior]") {
    ...
    SECTION("Testing DPP with 3 dirichlet pairs") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t981.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t982-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing DPP with 3 dirichlet pairs and fully parameterized without TimeMeanSizeRateMixer",
    ...
    SECTION("Testing DPP with 3 dirichlet pairs without TimeMeanSizeRateMixer") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t983.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t984-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing DPP with 3 dirichlet pairs and fully parameterized with only TimeMeanSizeRateMixer",
    ...
    SECTION("Testing DPP with 3 dirichlet pairs with only TimeMeanSizeRateMixer") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t985.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t986-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing ReversibleJumpSampler with 2 dirichlet singletons, 1 dirichlet pair, and fully parameterized",
    ...
    SECTION("Testing rjMCMC with 2 singletons and a pair") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t987.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t988-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing ReversibleJumpSampler with 2 dirichlet singletons, 1 dirichlet pair, and fully parameterized with no TimeMeanSizeRateMixer",
    ...
    SECTION("Testing rjMCMC with 2 singletons and a pair and no TimeMeanSizeRateMixer") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t989.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t990-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing ReversibleJumpSampler with 2 dirichlet singletons, 1 dirichlet pair, and fully parameterized with only TimeMeanSizeRateMixer",
    ...
    SECTION("Testing rjMCMC with 2 singletons and a pair and only TimeMeanSizeRateMixer") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t991.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t992-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing relative root models with with mix of 5 comparisons", "[SamplingPrior]") {
    ...
    SECTION("Testing relative root models") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "t993.cfg";
        std::string log_path = "data/tmp-config-" + tag + "t994-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
