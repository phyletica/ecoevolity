...
TEST_CASE("Testing WDP with 2 pairs and alpha 1.0, discount 0", "[xSamplingPrior]") {
    ...
    SECTION("Testing alpha fixed to 1.0, dscount 0") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "-twdp1.cfg";
        std::string log_path = "data/tmp-config-" + tag + "-twdp1-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing WDP with 2 pairs and alpha 1.0, discount 0.5", "[xSamplingPrior]") {
    ...
    SECTION("Testing alpha fixed to 1.0, dscount 0.5") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "-twdp2.cfg";
        std::string log_path = "data/tmp-config-" + tag + "-twdp2-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing WDP with 3 pairs and alpha 1.5, discount 0.7", "[xSamplingPrior]") {
    ...
    SECTION("Testing alpha fixed to 1.5, discount 0.7") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "-twdp3.cfg";
        std::string log_path = "data/tmp-config-" + tag + "-twdp3-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing WDP with 6 pairs and alpha 1.7, discount 0.2", "[xSamplingPrior]") {
    ...
    SECTION("Testing alpha fixed to 1.7, discount 0.2") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "-twdp4.cfg";
        std::string log_path = "data/tmp-config-" + tag + "-twdp4-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
        ...
        for (std::string m: {"000000", "012345", "012344", "012340", "001234", "012314"}) {
            REQUIRE((model_counts.at(m) / 100001.0) == Approx(std::exp(
                    get_wdp_log_prior_probability(m, concentration, discount))).epsilon(0.002));
        }
...
TEST_CASE("Testing WDP with 3 pairs and fully parameterized", "[xSamplingPrior]") {
    ...
    SECTION("Testing alpha and discount integrated") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "-twdp5.cfg";
        std::string log_path = "data/tmp-config-" + tag + "-twdp5-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
...
TEST_CASE("Testing WDP with 2 singletons and 1 pair, fully parameterized",
        "[xSamplingPrior]") {
    ...
    SECTION("Testing alpha and discount integrated") {
        ...
        std::string auto_optimize = "true";
        std::string tag = _PRIOR_SAMPLING_RNG.random_string(10);
        std::string test_path = "data/tmp-config-" + tag + "-twdp6.cfg";
        std::string log_path = "data/tmp-config-" + tag + "-twdp6-state-run-1.log";
        std::ofstream os;
        os.open(test_path);
        os << "event_time_prior:\n";
        os << "    gamma_distribution:\n";
