...
TEST_CASE("Testing RootHeightScaler with 3 leaves, gamma root, optimizing, and fixed internals",
        "[RootHeightScaler]") {
...
TEST_CASE("Testing RootHeightScaler with 4 leaves, gamma root, optimizing, fixed internals",
        "[RootHeightScaler]") {
