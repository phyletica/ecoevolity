...
TEST_CASE("Testing collection settings from minimal config", "[CollectionSettings]") {
    SECTION("Testing data/minimal-config.yml") {
        ...
        e += "            weight: 0\n";
        e += "            scale: 0.5\n";
        e += "        CompositeTimeSizeRateMixer:\n";
        e += "            weight: 1\n";
        e += "            scale: 0.5\n";
        e += "        CompositeTimeSizeRateScaler:\n";
        e += "            weight: 0\n";
        e += "            scale: 0.5\n";
        e += "        EventTimeScaler:\n";
        e += "            weight: 1\n";
...
TEST_CASE("Testing DirichletCollectionSettings invalid CompositeTimeSizeRateScaler", "[DirichletCollectionSettings]") {
    SECTION("Testing minimal two comparisons") {
        std::string cfg_path = "data/dummy.yml";
        ...
        cfg_stream << "    operators:\n";
        cfg_stream << "        CompositeTimeSizeScaler:\n";
        cfg_stream << "            weight: 1\n";
        cfg_stream << "            scale: 0.5\n";
